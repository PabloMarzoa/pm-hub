...
////////Component imports
import { PmdsCdkCalendarDayClassDirective } from './pmds-cdk-calendar-day-class.directive';

@Component({
	standalone: true,
    template: `
		<div pmdsCdkCalendarDayClass id="directive"
			[pmdsCdkCalendarDayClassDay]="day"
			[pmdsCdkCalendarDayClassMonth]="displayMonth"
			[pmdsCdkCalendarDayClassYear]="displayYear"
			[pmdsCdkCalendarDayClassSelectedDate]="selectedDate"
			[pmdsCdkCalendarDayClassDateEvents]="dateInfo"
		>Test</div>
    `,
	imports: [
...
describe('PmdsCdkCalendarDayClassDirective', () => {
